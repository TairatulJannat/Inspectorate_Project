<script>
    ...
    $('#save_info').off().on('submit', function(event) {
        ...
        $.ajax({
            ...
            error: function(response) {
                ...
                $('#error_jpsi_received_date').text(response.responseJSON.errors
                    .jpsi_received_date);
                $('#error_jpsi_reference_date').text(response.responseJSON.errors
                    .jpsi_reference_date);
    ...
    function clear_error_field() {
        ...
        $('#error_jpsi_received_date').text("");
        $('#error_jpsi_reference_date').text("");
