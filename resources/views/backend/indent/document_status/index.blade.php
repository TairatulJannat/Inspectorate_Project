...
@section('content')
    ...
    @include('backend.indent.document_status.create')
    {{-- Edit Item Type --}}
    @include('backend.indent.document_status.edit')
    {{-- Show Item Type --}}
    @include('backend.indent.document_status.show')
@endsection
...
@push('custom-scripts')
    ...
    @include('backend.indent.document_status.index_js')
@endpush
