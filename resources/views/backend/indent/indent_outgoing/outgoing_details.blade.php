...
@section('content')
    ...
    @include('backend.indent.cover_letter.cover_letter_create')

    {{-- start Modal for cover letter --}}

    {{-- start edit cover letter --}}
    @if ($cover_letter)
        @include('backend.indent.cover_letter.cover_letter_edit')
    @endif
...
@push('js')
    ...
    @include('backend.indent.cover_letter.cover_letter_js')
