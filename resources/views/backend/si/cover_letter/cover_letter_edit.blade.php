                ...
                <div class="row">
                    <form action="" id="editForm">
                        ...
                        <div class="col-12 d-flex justify-content-center">
                            <div class="col-2">
                                <select name="page_sizeEdit" class="form-control bg-success text-light" id="page_sizeEdit">
                                    <option value="">Select Page Size</option>
                                    <option value="A4" {{ $cover_letter->page_size == 'A4' ? 'selected' : '' }}>
                                        A4
                                    </option>
                                    <option value="Legal"
                                        {{ $cover_letter->page_size== 'Legal' ? 'selected' : '' }}>
                                        Legal</option>
                                    <option value="Letter"
                                        {{ $cover_letter->page_size == 'Letter' ? 'selected' : '' }}>
                                        Letter</option>
                                </select>
                            </div>
                            <div class="col-3">
                        ...
                        <input type="hidden" id="doc_type_id" value="11">
