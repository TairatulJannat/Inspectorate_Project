...
@section('active_menu', 'Add Contract')
@section('content')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="contract_received_date"
                                    name="contract_received_date" value={{ \Carbon\Carbon::now()->format('Y-m-d') }}>
...
@push('js')
    ...
    @include('backend.contract.contract_incomming_new.index_js')
