    ...
    $(function() {
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: {
                ...
                url: "{{ url('admin/contract/all_data') }}",
                type: 'GET',
                data: function(d) {
                    d._token = '{{ csrf_token() }}'
                }
    ...
    $('#save_info').off().on('submit', function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                setTimeout(window.location.href = "{{ route('admin.contract/view') }}", 40000);
            },
            error: function(response) {
                ...
                $('#error_contract_received_date').text(response.responseJSON.errors
                    .contract_received_date);
                $('#error_contract_reference_date').text(response.responseJSON.errors
