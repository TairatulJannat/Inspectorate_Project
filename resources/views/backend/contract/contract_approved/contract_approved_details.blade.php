@extends('backend.app')
@section('title', 'Contract (On Process)')
@push('css')
...
@endpush
@section('main_menu', 'Contract (On Process) ')
...
@push('js')
    ...
    @include('backend.contract.contract_approved.contract_approved_index_js')
            ...
            $('#submitBtn').off('click').on('click', function(event) {
                ...
                swal({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '{{ url('admin/contract_approved/tracking') }}',
                            data: {
                                ...
                                if (response) {
                                    if (response.permission === false) {
                                        ...
                                        setTimeout(window.location.href =
                                            "{{ route('admin.contract_approved/view') }}",
                                            40000);
                                    }
                                }
                            },
