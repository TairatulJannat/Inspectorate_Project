<div class="inote_boc mb-2">
    <form action="" id='saveDaviation' method="POST" enctype="multipart/form-data">
        <div class="container">
            <div class="py-3"><h3 class="text-center">APPLICATION FOR DEVIATION</h3></div>
            <div class="row">
                <h5>1. Details of contract</h5>
                <div class="col-md-12 p-2">
                    <label for="file_no"> File no:</label>
                    <input type="text" id="file_no" class="form-control">
                </div>
                ...
                <div class="col-md-6 p-2">
                    ...
                    <input type="text" id="contract_and_date" class="form-control">
                </div>
                <div class="col-md-6 p-2">
                ...
                <div class="col-md-6 p-2">
                    ...
                    <input type="text" id="quantity" class="form-control mt-2"  placeholder="(1) On order">
                    <input type="text" id="quantity" class="form-control mt-2"  placeholder="(2) Deviation required">
                    <input type="text" id="quantity" class="form-control mt-2"  placeholder="(3) Accepted to date">
                </div>
                <div class="col-md-6 p-2">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-12">
                    <textarea name="" class="form-control" id="" cols="30" rows="10">a.</textarea>
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-12">
                    <textarea name="" class="form-control" id="" cols="30" rows="10">6. The deviation (s) applied for avobe is/are recommended/sanctioned in full .......% perice reduction is in part ................above</textarea>
                </div>
