...
@section('content')
    ...
    @include('backend.inote.cover_letter.cover_letter_create')
    ...
    @if ($cover_letter)
        @include('backend.inote.cover_letter.cover_letter_edit')
    @endif
...
@push('js')
    ...
    @include('backend.inote.cover_letter.cover_letter_js')
            ...
            $('#submitBtn').off('click').on('click', function(event) {
                ...
                swal({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '{{ url('admin/outgoing_inote/tracking') }}',
                            data: {
