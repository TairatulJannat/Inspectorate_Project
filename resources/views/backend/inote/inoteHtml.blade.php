                ...
                <div class="content">
                    ...
                    <div class="col-6">
                        <div class=" col-12 d-flex justify-content-between">
                            ...
                            <div class=" d-flex col-4 p-2">কপি সংখ্যা : <input type="text" class="form-control"></div>
                        </div>
                        <div class=" col-12 d-flex justify-content-between">
            ...
            <div class="container mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="inspectionNumber">৬ দ্রব্যাদি পরিদর্শনের জন্য অর্পন/প্রেরন রেলযোগে করা হইল-</label>
                            <input type="text" id="inspectionNumber" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  rowspan="2" colspan="3"> <textarea name="" id="" class="form-control"></textarea></td>
                        ...
                        <tr>
                            ...
                            <td colspan="8"> <textarea name="" id="" class="form-control"></textarea></td>
