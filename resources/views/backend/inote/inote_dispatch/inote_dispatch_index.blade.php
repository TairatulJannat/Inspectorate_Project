...
@endpush
@section('main_menu', 'I-Note (Dispatch)')
            ...
            <div class="card-header">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="d-flex justify-content-between px-4 py-2">
                        ...
                        <div class="col-9">
                            <a href="{{ route('admin.inote/view') }}" type="button" class="btn btn-success btn-sm">New
                                Arrival ({{$inoteNew}})</a>
                            <a href="{{ route('admin.inote_approved/view') }}" type="button"
                                class="btn btn-secondary btn-sm">On Process ({{$inoteOnProcess}})</a>
                            <a href="{{ route('admin.inote/outgoing') }}" type="button"
                                class="btn btn-info text-white btn-sm">Completed ({{$inoteCompleted}})</a>
                            <a href="{{ route('admin.inote_dispatch/view') }}" type="button"
                                class="btn btn-danger btn-sm">Dispatch ({{$inoteDispatch}})</a>
...
@push('js')
    ...
    @include('backend.inote.inote_dispatch.inote_dispatch_index_js')
@endpush
