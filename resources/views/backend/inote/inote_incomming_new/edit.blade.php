            ...
            <form action="" id="update_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="hidden" value=" {{ $inote->id }}" id="editId" name="editId">
                                ...
                                <select class="form-control " id="sender" name="sender">
                                    ...
                                    @foreach ($dte_managments as $dte)
                                        <option value="{{ $dte->id }}"
                                            {{ $dte->id == $inote->sender_id ? 'selected' : '' }}>{{ $dte->name }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="reference_no" name="reference_no"
                                    value="{{ $inote->reference_no ? $inote->reference_no : '' }} ">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="inote_reference_date"
                                    name="inote_reference_date"
                                    value="{{ $inote->reference_date ? $inote->reference_date : '' }}">
                                <span id="error_inote_reference_date" class="text-danger error_field"></span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="contract_no"
                                    name="contract_no"
                                    value="{{ $inote->contract_no ? $inote->contract_no : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="contract_date"
                                    name="contract_date"
                                    value="{{ $inote->contract_date ? $inote->contract_date : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="indent_reference_no"
                                    ...
                                    value="{{ $inote->indent_reference_no ? $inote->contract_reference_no : '' }} ">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="offer_reference_no" name="offer_reference_no"
                                    value="{{ $inote->offer_reference_no ? $inote->offer_reference_no : '' }} ">
                                ...
                                <select name="supplier_id" id="supplier_id" class="form-control">
                                    ...
                                    @if ($supplier)
                                        <option value="{{ $supplier->id }}"
                                            {{ $supplier->id == $inote->supplier_id ? 'selected' : '' }}>
                                            {{ $supplier->firm_name }}
                                        </option>
                                    @endif
                                </select>
                                ...
                                <select class="form-control" id="item_type_id" name="item_type_id" required>
                                    ...
                                    @foreach ($item_types as $item_type)
                                        <option value="{{ $item_type->id }}"
                                            {{ $item_type->id == $inote->item_type_id ? 'selected' : '' }}>
                                            {{ $item_type->name }}
                                        </option>
                                    @endforeach
                                ...
                                <select class="form-control" id="fin_year_id" name="fin_year_id" required>
                                    ...
                                    @foreach ($fin_years as $fin_year)
                                        <option value={{ $fin_year->id }}
                                            {{ $fin_year->id == $inote->fin_year_id ? 'selected' : '' }}>
                                            {{ $fin_year->year }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea name="remark" id="remark" class="form-control"> {{ $inote->remarks ? $inote->remarks : '' }}</textarea>
                ...
                <div class="card-footer text-end">
                    <div class="col-sm-9 offset-sm-3">
                        <a href="{{ route('admin.inote/view') }}" type="button" class="btn btn-secondary">Cancel</a>
