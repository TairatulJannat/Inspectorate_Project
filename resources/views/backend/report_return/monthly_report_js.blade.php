...
<script>
    ...
    $('#monthlyForm').submit(function(e) {
        ...
        $.ajax({
            url: '{{ url('admin/report_returns/monthly_store') }}',
            method: 'POST',
            data: formData,
            headers: {
    ...
    $('#monthly_rr_filter_btn').click(function(event) {
        ...
        $.ajax({
            url: "{{ url('admin/rr/monthly_report_data') }}",
            type: "POST",
            data: {
                'fromDate': fromDate,
                'toDate': toDate
                ...
                <div class="">
                    <div class="">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myLargeModalLabel">Monthly Report</h4>
