    ...
    $(document).ready(function() {
        ...
        $(function() {
            var table = $('.yajra-datatable').DataTable({
                ...
                ajax: {
                    url: "{{ url('admin/doc-type/get-all-data') }}",
                    type: 'POST',
                    headers: {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return '<td class="dt-center px-0">' +
                                '<button class="btn btn-sm me-2 show-doc-type fa fa-eye" id="' +
                                row.id +
                                '" data-bs-toggle="tooltip" data-bs-placement="top" title="View"></button>' +
                                '<button class="btn btn-secondary btn-sm me-2 edit-doc-type fa fa-edit" id="' +
                                row.id +
                                '" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"></button>' +
                                '<button class="btn btn-danger btn-sm me-2 delete-doc-type fa fa-trash-o" id="' +
                                row.id +
        ...
        // Create Doc Type
        $("#createDocTypeForm").on("submit", function(e) {
            e.preventDefault();
            var form = this;
